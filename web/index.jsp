...
<head>
  ...
  <link rel="icon" href="${ctx}/api/static/images/favicon.ico" type="image/ico">
  <meta name="keywords" content="LightYear,光年,后台模板,后台管理系统,光年HTML模板">
  <meta name="description" content="LightYear是一个基于Bootstrap v3.3.7的后台管理系统的HTML模板。">
  <meta name="author" content="yinqi">
  <link rel="stylesheet" href="https://www.jq22.com/jquery/bootstrap-3.3.4.css">
  <link href="${ctx}/api/static/bootstrap/css/materialdesignicons.min.css" rel="stylesheet">
  <link href="${ctx}/api/static/bootstrap/css/style.min.css" rel="stylesheet">
  <style>
    .lyear-wrapper {
      position: relative;
    }
    ...
    if (checkInput()){
      $.ajax({
        ...
        data:{
          ...
          if (res.code==200){
            //登录成功，跳转主页
            location.href="${ctx}/pages/table.jsp";
          }else {
            alert(res.msg);
          }
        }
